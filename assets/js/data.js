...
var dataRecd=[ 
			  ...
			  'floatcenterBold tmidalign',
					...
					'checklister':[['Find the file card for Crystal Net Inc behind the "Uncoded Cards" guide in the alphabetic card file.'],[ 'Bring it to the main task screen and code it with a "G" in the upper right corner.'],['File the card behind the "C" guide in the card file.'],['Code the letter with a G in the upper right corner and file it in the "C" folder in the correspondence file.']],
					'aslash':[[],[[0,1,2]],[],[],[],[],[],[],[],[],[],[],[],[],[]],
					'numbering':[],
			   ...
			   'alignClass':['SubInputTop',
					...
					'checklister':[['','Applications correspondence is filed in an individual folder because Auric Systems, Inc. is likely to receive more correspondence about that subject. Therefore, APPLICATIONS becomes the first numbered folder in the numeric file.'],['Find the file card prepared for Carter Chris and bring it to the main task screen.'],[ 'Open the Accession Log and see that 100 is the next available number to be assigned. Type "Applications" into the Accession Log next to the number 100.'],['Then, type "100" into the upper right corner of the Carter Chris file card.'],['','In your alphabetic card file, you will need a card for Applications, a subject. This is necessary because you may forget what number has been assigned to applications correspondence, or someone else may be looking for the applications correspondence and not know the assigned number. Therefore, an Applications card has been prepared.'],['Find the Applications card and code it 100 also.'],['Type "100" in the upper right corner of the letter.'],["File the Applications card behind the A guide in the card file."],["File Carter Chris card behind the C guide in your card file."],["Create a folder titled \"100\" and file it behind guide 100 in the correspondence file as the first numbered folder in your file."],["File Chris Carter's application letter in the new 100 folder."]],
				    'aslash':[[],[],[],[],[],[[],[]],[],[],[],[],[],[[0]],[],[]],
					'numbering':[],
			   ...
			   'alignClass':['SubInputTop',
					...
					'checklister':[['Retrieve the alphabetic card for Above and Beyond Insurance Co.'],[ 'Code the card with a G and file it behind the A guide in the card file.'],['Code the letter with a G and file it in the A folder of your correspondence file.']],
                    'aslash':[[],[],[[0,1,2,3]],[],[],[],[],[],[],[],[],[]],
					'numbering':[],
			  ...
			  'alignClass':['SubInputTop',
					...
					'checklister':[['','Reference to the card file shows that a card has already been prepared for Above & Beyond Insurance Co. Therefore, an individual folder should be opened now because you have a second piece of correspondence with the same name and address as the first one.'],['Refer to your Accession Log to see that 101 is the next number available for assignment. Type "Above and Beyond Insurance Co" into the Accession Log next to the number 101.'],['Retrieve the Above and Beyond Insurance Co card and change G to 101 on the file card.'],['Refile the card in correct alphabetic order.'],['Type "101" in the upper right corner of the letter.'],['Create a folder titled 101 and file it behind the 100 folder.'],['Retrieve the previous Above & Beyond Insurance Co letter from the A folder in the numeric correspondence file; change the G on the letter to 101.'],['File both Above & Beyond letters in the new 101 folder.'],['Open the new 101 folder for a fine sort, filing the more recently dated letter in front.']],
                    'aslash':[[],[],[],[],[],[],[],[],[[],[0,1,2,3]],[],[],[],[],[],[]],
					'numbering':[],
			  ...
			  'alignClass':['SubInputTop',
					...
					'checklister':[['','This piece bears a handwritten note to open an individual folder.'],['Refer to the Accession Log for the next number to assign. Type "International Computing Center" next to 103 on the log'],['Type 103 into the file card for International Computing Center.'],['Since there is also a cross-reference file card, find it (Centro de Computacion International) and code it with a 103.'],['File the original card in the "I" section and the cross-reference card in the "C" section of the card file.'],['Code the letter with 103.'],['Create a 103 folder and file it behind the 102 folder.'],['File the letter in the new 103 folder.']],
					'aslash':[[],[],[],[],[],[[],[],[],[]],[],[],[],[],[],[],[],[],[]],
					'numbering':[],
